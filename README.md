...
Шаг 4: Выбираем папку, куда нужно сохранить новый файл (с теми артикулами, которые совпали в первом и втором файле)</br>
Жмем Найти и ждём.
</div>
 
<h2 align="center">CONTACT<br>(cвязаться со мной)</h2>
